  ...
  <div class="app-container" v-loading="loading" :element-loading-text="loadingText">
    ...
    <div v-if="careHistory.registrationId !== undefined">
      ...
      <el-card class="box-card">
        ...
        <el-button type="primary" size="small" icon="el-icon-money" @click="handlePayWithCash">现金</el-button>
        <el-button type="primary" size="small" icon="el-icon-bank-card" @click="handlePayWithAliPay">支付宝支付</el-button>
